...
export interface DancerCircleProps {
  ...
  onContextMenu?: (e: React.MouseEvent) => void;  // Right-click for quick swap
...
export function DancerCircle({
  ...
  return (
    <g
      style={{ cursor: onMouseDown || onClick || onDoubleClick || onContextMenu ? 'pointer' : 'default', opacity, ...style }}
      onClick={onClick}
